                                                              ...
                                                              FlatButton(
                                                                ...
                                                                onPressed: (){
                                                                 setState(() {
                                                                   ...
                                                                   //사용자가 예약취소를 했을때 TongmyungDomitory2 컬렉션에서 남은 침대나 방의 개수를 다시 증가시켜주는 메소드이다.
                                                                   Increase_supply();
...
//                                        new GettingStartedScreen()));
  ...
  //사용자가 예약취소를 했을때 TongmyungDomitory2 컬렉션에서 남은 침대나 방의 개수를 다시 증가시켜주는 메소드이다.
  void Increase_supply() {
    print("Increase_supply 메소드가 호출됨");
    ...
    for(int i=0;i<time_differ_Integer;i++){
      Firestore.instance.collection('Tongmyung_dormitory2').document(time.toString().substring(0,10)).updateData(<String, dynamic>{_roomName_eng : FieldValue.increment(inpeople)});
